...
"
    >
      <div className=" inline-flex item-center gap-2 border border-gray-300 p-1.5 pr-4 rounded-full">
      ...
      <p className=" text-sm sm:text-lg font-medium text-gray-500 dark:text-white/75 max-w-4/5 sm:max-w-lg pb-3">
        Creating meanigful connections and truning big ideas into interactive
        digital experiences
      </p>
